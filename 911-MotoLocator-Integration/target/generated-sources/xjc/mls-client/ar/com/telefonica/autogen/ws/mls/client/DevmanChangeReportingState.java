 ...
 *         &lt;element name="state" type="{http://www.motorola.com/mls}DeviceReportingState"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "devman_ChangeReportingState")
public class DevmanChangeReportingState {

    protected ArrayOfString names;
    @XmlElement(required = true)
    @XmlSchemaType(name = "string")
    protected DeviceReportingState state;
     ...
     * @return
     *     possible object is
     *     {@link DeviceReportingState }
     *     
     */
    public DeviceReportingState getState() {
        return state;
    }
     ...
     *     
     */
    public void setState(DeviceReportingState value) {
        this.state = value;
    }
